  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-7xl max-h-[90vh] overflow-hidden border border-gray-100 flex flex-col">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-blue-100 mt-1 text-sm">Explore and access additional features and capabilities</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto flex-1 min-h-0">
              ...
              {MODULE_CATEGORIES.map((category) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center space-x-2 px-3 py-2 text-sm rounded-xl font-medium transition-all duration-200 ${
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <div className={`flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(module.enabled)}`}>
                  ...
                  {module.enabled && (
                    <div className="mt-3 pt-3 border-t border-gray-100">
                      <button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white h-10 px-4 py-2 text-sm rounded-lg font-medium transition-all duration-200 shadow-sm hover:shadow-md">
                        Open Module
                      </button>
                    </div>
                  )}
          ...
          <div className="mt-4 bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-2xl p-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="font-semibold text-blue-900 mb-1 text-sm">Module System</h4>
        ...
        {/* Footer */}
        <div className="bg-gray-50 border-t border-gray-200 px-8 py-4 flex-shrink-0">
          <div className="flex justify-end">
            <button
              onClick={onClose}
              className="h-10 px-4 py-2 bg-gradient-to-r from-gray-600 to-gray-700 hover:from-gray-700 hover:to-gray-800 text-white text-sm rounded-xl font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              Close
            </button>
          </div>
