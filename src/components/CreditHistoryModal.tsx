      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-hidden border border-gray-100 flex flex-col">
          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-purple-100 text-xs">Track credit block usage and renewals</p>
              </div>
            </div>
            <button
              onClick={onClose}
            ...
            <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-semibold text-blue-900">{totalBlocks}</p>
                </div>
            ...
            <div className="bg-purple-50 rounded-lg p-3 border border-purple-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-semibold text-purple-900">{totalCreditsPurchased}</p>
                </div>
            ...
            <div className="bg-green-50 rounded-lg p-3 border border-green-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-semibold text-green-900">{totalCreditsUsed.toFixed(2)}</p>
                </div>
            ...
            <div className="bg-orange-50 rounded-lg p-3 border border-orange-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`text-lg font-semibold ${remainingCredits < 0 ? 'text-red-900' : 'text-orange-900'}`}>
          ...
          <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm">
            <div className="bg-gray-50 px-6 py-3 border-b border-gray-200">
              <div className="flex items-center space-x-2">
                ...
                <h3 className="text-base font-semibold text-gray-900">Credit Blocks ({totalBlocks})</h3>
              </div>
            </div>
        ...
        <div className="bg-gray-50 border-t border-gray-200 px-6 py-4 flex-shrink-0">
          <div className="flex justify-end">
            <button
              onClick={onClose}
              className="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg font-medium transition-all duration-200 shadow-sm hover:shadow-md text-sm"
            >
              Close
            </button>
          </div>
